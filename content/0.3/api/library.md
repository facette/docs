...
<div class="note"><span class="fa fa-info-circle"></span> <strong>Note:</strong> Template attributes must follow Go
template syntax (e.g. <code>{{ .attr1 }}</code>).</div>
...
<div class="note"><span class="fa fa-info-circle"></span> <strong>Note:</strong> don't specify a <code>id</code>
parameter when creating a resource, the back-end assigns an unique identifier at creation.</div>
